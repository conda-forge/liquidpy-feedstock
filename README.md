...
Once the `conda-forge` channel has been enabled, `liquidpy` can be installed with:

```
conda install liquidpy
```

It is possible to list all of the versions of `liquidpy` available on your platform with:
